...
/** Typed errors for terminal UI operations.
  *
  * All errors in zio-tui are explicitly typed and never thrown as exceptions. This enables exhaustive pattern matching
...
enum TUIError:
  /** Terminal initialization failed.
    *
    * @param reason
    *   Description of what caused the initialization failure
    */
  ...
  /** Rendering operation failed.
    *
    * @param widget
    *   The widget that failed to render
    * @param cause
  ...
  /** Invalid terminal dimensions or size.
    *
    * @param width
    *   The requested or current width
    * @param height
    *   The requested or current height
    * @param reason
    *   Description of why the dimensions are invalid
    */
